...
Пользователь отложил задачу «${taskTitle}» ${snoozeCount ?? 0} раз(а). Сейчас ступень эскалации ${stage} из 7 — 1 это максимально мягко и спокойно, 7 это предельно едко и устало, но без грубости и оскорблений.
Придумай ДВЕ короткие фразы от лица персонажа (каждая до 90 символов) в тоне, соответствующем ступени ${stage}. Каждый раз — новые формулировки, не повторяйся.
